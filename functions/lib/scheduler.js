...
exports.triggerVendorSync = exports.nightlyVendorSync = void 0;
const functions = __importStar(require("firebase-functions"));
const admin = __importStar(require("firebase-admin"));
const axios_1 = __importDefault(require("axios"));
const db = admin.firestore();
exports.nightlyVendorSync = functions.pubsub
    ...
    try {
      ...
      const syncPromises = vendorsQuery.docs.map(async (vendorDoc) => {
        ...
        try {
          ...
          const response = await axios_1.default.get(vendor.apiUrl, {
...
exports.triggerVendorSync = functions.https.onCall(async (data, context) => {
