...
-- Uses TRUNCATE-style approach: disable FK checks temporarily

BEGIN;

-- Temporarily defer all FK constraints
SET CONSTRAINTS ALL DEFERRED;

-- Delete ALL data in every table that references this org
-- Order doesn't matter with deferred constraints
...
-- Verify: should only show "My Company"
